...
function renderQuote(){
  var randomQuote = Math.floor(Math.random() * jokesArray.length);
  var quoteRendered = document.createElement('p');
  quoteRendered.textContent = 'Hey ' + userNameStored + ' ' + randomQuote;
  footerContent.appendChild(quoteRendered);
}
