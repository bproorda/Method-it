...
var methodAnswer = ["[1, 2, 3, 4, 5, 6]", "['d', 'd', 'e', 'd', 'e']", "[0, 'a']", "true", "[6, 6, 6, 6]", "['exuberant', 'destruction', 'present']", "12", "3", "'a'", "['b', 'r', 'e', 'n', 'n']", "true", "1", "false","'stacey'","[0, 1, 2]", "4", "false", "[3, 9, 27]", "[98, 47, 36, 62]", "[87, 56, 34, 21]", "6", "6", "1", "['stacey', 'francesco']", "[1, 9, 13]", "false", "'brenn'", "[6, 7, 8, 9]", "'1b5'", "0"];
var nodeNumber = 8;
