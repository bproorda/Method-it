...
var methodQuestions = ["var arrayOne = [1, 2, 3]<br> var arrayTwo = [4, 5, 6] <br><br> What is the expected output of arrayOne.concat(arrayTwo);?<br>", "var arrayOne = ['a', 'b', 'c', 'd', 'e'];<br><br> What is the expected output of arrayOne.copyWithin(1, 3);?", "var array = ['a', 'b', 'c'];<br> var iterator = array.entries();<br><br> for (var e of iterator) { <br>console.log(e); <br>}<br><br>What is the first array of the expected output?", "var isBelowThreshold = (currentValue) => currentValue < 40;<br>var array1 = [1, 30, 39, 29, 10, 13];<br>Will (array1.every(isBelowThreshold)); return true or false?", "var array1 = [1, 2, 3, 4];<br>What is the expected output of array1.fill(6); ?", "var words = ['spray', 'limit', 'elite', 'exuberant', 'destruction', 'present'];<br><br>What is the expected output of words.filter(word => word.length > 6);?", "var arrayOne = [5, 12, 8, 130, 44];<br><br>What is the expected output of arrayOne.find(element => element > 10);?", "var arrayOne = [5, 12, 8, 130, 44];<br>var isLargeNumber = (element) => element > 13;<br><br>What is the expected output of arrayOne.findIndex(isLargeNumber);?", "var arrayOne = [1, 2, 3, 4];<br>var arrayTwo = [];<br><br>function plusOne(element){<br>element++;<br>arrayTwo.push(element)<br>}<br>arrayOne.forEach(plusOne);<br><br>What will arrayTwo be?", "var newArray =  Array.from(‘brenn’);<br>What will newArray look like?", "var truthyOrFalsy = [5, 6, 3].includes(3);<br><br>Will the new variable be true or false?", "var newArray = [31, 13, 31];<br>var lookFor = 13;<br>var index13 =newArray.indexOf(lookFor);<br><br>What will the value of index13 be?", "var myArray = 'I am an Array';<br>var truthyOrFalsy =  myArray.isArray;<br><br>Will this return true or false?", "var herArray = [‘s’, ‘ta’, ‘ce’, ‘y’];<br>var answer = herArray.join(‘’);<br><br>What is the answer?", "var list = [9, 7, 5]<br>var keys = [...list.keys()];<br><br>What does keys look like?", "var us = [‘francesco’, ‘stacey’, ‘francesco’, ‘brenn’, ‘francesco’];<br>us.lastIndexOf(‘francesco’);<br><br>What does this return?", "var others = ['chase', 'marie', 'craig', 'matt'];<br>var v = others.valueOf();<br><br>Do variable others and v have different values? true or false?", "var oldStuff = [1, 3, 9];<br>var newStuff = oldStuff.map(x => x*3);<br>console.log(newStuff);<br><br>What will be logged in the console?", "var amountOfSodas = [98, 47, 36, 62, 87]<br>amountOfSodas.pop();<br><br>What will the amountOfSodas return?", "var yetAnotherArray = [87, 56, 34];<br>yetAnotherArray.push(21);<br><br>What will the yetAnotherArray return?", "var arr = [10, 3, 2];<br>function sumofArray(sum, num) {<br>return sum - num;<br>}<br>Function thisStuff(item) {<br>document.getElementById('new').innerHTML<br> = arr.reduce(sumofArray);<br> }<br><br>What will be appended to the page?", "var numbers = [10, 2, 1]<br> function sumofArray(sum, num) {<br>    return sum - num;<br>}<br>function thisStuff(item) {<br>document.getElementById('new').innerHTML<br>  = arr.reduceRight(sumofArray);<br>        }<br><br>What will be appended to the page?", "arrayOne = [7, 8, 9, 1]<br>arrayTwo = arrayOne.reverse();<br><br>What item will be at index 0 in arrayTwo?", "array934 = [‘brenn, ‘stacey’, ‘francesco’];<br>array935 = array935.shift();<br><br>What will the 'array935' return?", "tooMany = [5, 7, 1, 9, 13, 6]<br>justRight = tooMany.slice(2, 5);<br><br>What will justRight return?", "var isBelowThreshold = (currentValue) => currentValue < 10;<br>var arrayOne = [15, 30, 39, 29, 10, 3];<br><br>What is the expected output of (arrayOne.every(isBelowThreshold));?", "weBeTeamMongoose = ['francesco', 'stacey', 'brenn'];<br>newArray = weBeTeamMongoose.sort()<br><br>Which item will be index 0 in newArray?", "teams  = [6, 8, 9];<br>Teams.splice(1,0,7)<br><br>What will teams look like now?", "what = [1,’b’, 5];<br>what.toString();<br><br>What will be the final array?", "lastEverArray = [5, 22, 9, 46]<br>lastEverArray.unshift(11);<br><br>What will be the index position of the new item?"];
var methodAnswer = ["[1, 2, 3, 4, 5, 6]", "['d', 'd', 'e', 'd', 'e']", "[0, 'a']", "true", "[6, 6, 6, 6]", "['exuberant', 'destruction', 'present']", "12", "2", "[2, 3, 4, 5]", "['b', 'r', 'e', 'n', 'n']", "true", "1", "false","'stacey'","[0, 1, 2]", "4", "false", "[3, 9, 27]", "[98, 47, 36, 62]", "[81, 56, 34, 21]", "5", "-11", "1", "['stacey', 'francesco']", "[1, 9, 13]", "true", "'brenn'", "[6, 7, 8, 9]", "'1b5'", "0"];
var nodeNumber = 8;
